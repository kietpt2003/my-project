...
import { CameraPage, PermissionsPagecamera, CodeScannerPage, MediaPage, CameraPageV2 } from './custom-camera/index'
        ...
        <NavigationContainer>
            <GestureHandlerRootView style={styles.root}>
                <Stack.Navigator
                    ...
                    <Stack.Screen name="PermissionsPage" component={PermissionsPagecamera} />
