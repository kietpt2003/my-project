...
import { StyleSheet, View, ActivityIndicator, PermissionsAndroid, Platform, Image, Text, TouchableOpacity } from 'react-native'
...
export function MediaPage({ navigation, route }: Props): React.ReactElement {
    ...
    return (
        <View style={[styles.container, screenStyle]}>
            ...
            <TouchableOpacity style={[styles.closeButton, { marginTop: 20 }]} onPress={navigation.goBack}>
                {/* <IonIcon name="close" size={35} color="white" style={styles.icon} /> */}
                <Text style={{ color: "white" }}>close</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.saveButton} onPress={onSavePressed} disabled={savingState !== 'none'}>
                {savingState === 'none' && <Text style={{ color: "white" }}>download</Text>}
                {savingState === 'saved' && <Text style={{ color: "white" }}>checkmark</Text>}
